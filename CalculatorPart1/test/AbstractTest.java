...
/**
 * This class represents an abstract test class for SimpleCalculator and
 * SmartCalculator. It contains tests that are similar for both classes.
 */
public abstract class AbstractTest {
  ...
  @Before
  public void setUp() {
    calculator1 = formCalculator();
    calculator2 = formCalculator();
    calculator3 = formCalculator();
    calculator4 = formCalculator();
    calculator5 = formCalculator();
    calculator6 = formCalculator();
  }

  protected abstract Calculator formCalculator();
  ...
  public void testAddition() {
    ...
    assertEquals("60", h2.getResult());

    Calculator i2 = h2.input('=');
    assertEquals("60", i2.getResult());
  ...
  public void testMultiplication() {
    ...
    Calculator e4 = d4.input('*').input('8');
    assertEquals("35*8", e4.getResult());

    Calculator f4 = e4.input('=');
    assertEquals("280", f4.getResult());
